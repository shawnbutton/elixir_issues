defmodule TableFormatterTest do
  ...
  def split_with_three_columns,
      do: TF.split_into_columns(TableFormatterTest.simple_test_data, TableFormatterTest.headers)

  test "split_into_columns" do
    columns = split_with_three_columns()
    assert length(columns) == length(TableFormatterTest.headers)
  ...
  test "Output is correct" do
    result = capture_io fn ->
      TF.print_table_for_columns(TableFormatterTest.simple_test_data, TableFormatterTest.headers)
    end
